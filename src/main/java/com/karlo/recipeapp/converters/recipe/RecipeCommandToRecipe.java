...
public class RecipeCommandToRecipe implements Converter<RecipeCommand, Recipe> {
    ...
    public RecipeCommandToRecipe(CategoryCommandToCategory categoryConverter, IngredientCommandToIngredient
            ingredientConverter, NotesCommandToNotes notesConverter) {
